document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add health theme banner dynamically if it doesn't exist
    if (!document.getElementById('health-banner')) {
        ...
        // Insert health banner after lab summary or at the beginning of main if lab summary doesn't exist
        const labSummarySection = document.getElementById('lab-summary');
        if (labSummarySection && labSummarySection.nextSibling) {
            mainElement.insertBefore(healthBanner, labSummarySection.nextSibling);
        } else if (labSummarySection) {
